...
* [RenPy Lipsync Plugin](https://github.com/Wendy-Nam/RenPy-Lipsync-Plugin) ⭐ 21 | 🐛 4 | 🌐 C++ | 📅 2025-07-02 - A plugin that stitches the [Rhubarb automated lip sync engine](https://github.com/DanielSWolf/rhubarb-lip-sync) ⭐ 2,573 | 🐛 25 | 🌐 C++ | 📅 2026-06-16 into RenPy.
...
* [Replacement blur](https://github.com/renpy/renpy/issues/4442#issuecomment-1470990844) ⭐ 6,711 | 🐛 291 | 🌐 Ren'Py | 📅 2026-08-13 - An alternative implementation of blur that overrides the stock blur.
...
* [Mysterious Messenger](https://github.com/shawna-p/mysterious-messenger) ⭐ 41 | 🐛 0 | 🌐 Ren'Py | 📅 2026-08-12 - An entire game built around a custom messenger imitation.
* [KatawaShoujo-RenPy8](https://github.com/gcammisa/KatawaShoujo-RenPy8) ⭐ 37 | 🐛 1 | 🌐 Ren'Py | 📅 2024-06-22 - A port of the classic Katawa Shoujo visual novel to run on modern versions of RenPy.
...
* [renpy2flatpak](https://github.com/dcbaker/renpy2flatpak) ⭐ 1 | 🐛 8 | 🌐 Python | 📅 2026-08-12 - A tool to automate packaging a Linux release of your project into Flatpak format for distribution.
