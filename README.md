...
* [RenPy Lipsync Plugin](https://github.com/Wendy-Nam/RenPy-Lipsync-Plugin) ⭐ 21 | 🐛 4 | 🌐 C++ | 📅 2025-07-02 - A plugin that stitches the [Rhubarb automated lip sync engine](https://github.com/DanielSWolf/rhubarb-lip-sync) ⭐ 2,575 | 🐛 25 | 🌐 C++ | 📅 2026-06-16 into RenPy.
...
* [Replacement blur](https://github.com/renpy/renpy/issues/4442#issuecomment-1470990844) ⭐ 6,717 | 🐛 289 | 🌐 Ren'Py | 📅 2026-08-14 - An alternative implementation of blur that overrides the stock blur.
...
* [MonikA.I](https://github.com/Rubiksman78/MonikA.I) ⭐ 163 | 🐛 8 | 🌐 Python | 📅 2025-09-10 - AI-based features for a mod for Doki Doki Literature Club, this is an advanced example of integrating RenPy with a chatbot.
* [Mysterious Messenger](https://github.com/shawna-p/mysterious-messenger) ⭐ 41 | 🐛 0 | 🌐 Ren'Py | 📅 2026-08-13 - An entire game built around a custom messenger imitation.
...
* [ActionEditor](https://github.com/kyouryuukunn/renpy-ActionEditor3) ⭐ 192 | 🐛 9 | 🌐 Ren'Py | 📅 2025-04-29 - A powerful director tool for manipulating [camera](https://www.renpy.org/doc/html/model.html), viewing the results and generating code to produce the interactively-defined effects.
...
* [renpy2flatpak](https://github.com/dcbaker/renpy2flatpak) ⭐ 1 | 🐛 10 | 🌐 Python | 📅 2026-08-13 - A tool to automate packaging a Linux release of your project into Flatpak format for distribution.
...
* [RPA Explorer](https://github.com/UniverseDevel/RPA-Explorer) ⭐ 101 | 🐛 2 | 🌐 JavaScript | 📅 2025-05-10 - Graphical explorer for RenPy Archives built around a C# library to manipulate them. Can also invoke `unrpyc` on the contents.
* [RenPy-UnAPK](https://github.com/DrDRR/RenPy-UnAPK) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2025-02-20 - A tool to unpack and decompile an Android build's APK file. Sparsely documented, but there's not much to document.
...
Other amazingly awesome lists can be found in [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,541 | 🐛 100 | 📅 2026-06-30, [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,196 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,608 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02.

Those should be of particular interest for RenPy users:

* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 313,886 | 🐛 26 | 🌐 Python | 📅 2026-08-05
