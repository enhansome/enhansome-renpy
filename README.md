...
* [Replacement blur](https://github.com/renpy/renpy/issues/4442#issuecomment-1470990844) ⭐ 6,861 | 🐛 298 | 🌐 Ren'Py | 📅 2026-09-26 - An alternative implementation of blur that overrides the stock blur.
...
* [unrpyc](https://github.com/CensoredUsername/unrpyc) ⭐ 1,258 | 🐛 11 | 🌐 Ren'Py | 📅 2026-02-24 - The `*.rpyc` file decompiler.
...
* [RPA Explorer](https://github.com/UniverseDevel/RPA-Explorer) ⭐ 107 | 🐛 2 | 🌐 JavaScript | 📅 2025-05-10 - Graphical explorer for RenPy Archives built around a C# library to manipulate them. Can also invoke `unrpyc` on the contents.
...
Other amazingly awesome lists can be found in [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,733 | 🐛 107 | 📅 2026-09-02, [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,214 | 🐛 28 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,688 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.

Those should be of particular interest for RenPy users:

* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 323,162 | 🐛 21 | 🌐 Python | 📅 2026-09-25
