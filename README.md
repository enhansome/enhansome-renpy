...
* [RenPy Lipsync Plugin](https://github.com/Wendy-Nam/RenPy-Lipsync-Plugin) ⭐ 21 | 🐛 4 | 🌐 C++ | 📅 2025-07-02 - A plugin that stitches the [Rhubarb automated lip sync engine](https://github.com/DanielSWolf/rhubarb-lip-sync) ⭐ 2,599 | 🐛 25 | 🌐 C++ | 📅 2026-06-16 into RenPy.
...
* [Replacement blur](https://github.com/renpy/renpy/issues/4442#issuecomment-1470990844) ⭐ 6,810 | 🐛 293 | 🌐 Ren'Py | 📅 2026-09-10 - An alternative implementation of blur that overrides the stock blur.
...
* [Mysterious Messenger](https://github.com/shawna-p/mysterious-messenger) ⭐ 41 | 🐛 0 | 🌐 Ren'Py | 📅 2026-09-09 - An entire game built around a custom messenger imitation.
...
Other amazingly awesome lists can be found in [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,696 | 🐛 106 | 📅 2026-09-02, [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,206 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,661 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.

Those should be of particular interest for RenPy users:

* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 319,672 | 🐛 18 | 🌐 Python | 📅 2026-09-01
