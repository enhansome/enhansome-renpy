...
* [RenPy Lipsync Plugin](https://github.com/Wendy-Nam/RenPy-Lipsync-Plugin) ⭐ 21 | 🐛 4 | 🌐 C++ | 📅 2025-07-02 - A plugin that stitches the [Rhubarb automated lip sync engine](https://github.com/DanielSWolf/rhubarb-lip-sync) ⭐ 2,625 | 🐛 25 | 🌐 C++ | 📅 2026-06-16 into RenPy.
...
* [RPG Battle Engine](https://github.com/Habitacle/battle-engine) ⭐ 113 | 🐛 0 | 🌐 Ren'Py | 📅 2021-05-27 - What it says on the tin.
...
* [Navigation Quest Time Routine System](https://github.com/DRincs-Productions/NQTR-toolkit) ⭐ 52 | 🐛 15 | 🌐 Ren'Py | 📅 2024-07-29 - A complete system introducing the concepts of location, time and event, producing the framework of a not-quite-point-and-click adventure game.
...
* [GalleryPlus](https://github.com/cheonbyeol/RenPy-GalleryPlus) ⭐ 16 | 🐛 0 | 🌐 Ren'Py | 📅 2021-04-18 - Extends the functionality of RenPy's built-in Gallery class. Allows looping images, pages, navigation buttons.
...
* [ChromaGlitch](https://github.com/Gouvernathor/renpy-ChromaGlitch) ⭐ 76 | 🐛 1 | 🌐 Python | 📅 2024-10-28 - Glitch effect.
...
* [Free-hand draw](https://github.com/jsfehler/renpy-freehand-draw) ⭐ 29 | 🐛 0 | 🌐 Ren'Py | 📅 2018-08-23 - Draw on a canvas inside a Ren'Py game.
...
* [Replacement blur](https://github.com/renpy/renpy/issues/4442#issuecomment-1470990844) ⭐ 6,851 | 🐛 293 | 🌐 Ren'Py | 📅 2026-09-22 - An alternative implementation of blur that overrides the stock blur.
...
* [Mysterious Messenger](https://github.com/shawna-p/mysterious-messenger) ⭐ 41 | 🐛 0 | 🌐 Ren'Py | 📅 2026-09-22 - An entire game built around a custom messenger imitation.
...
* [ActionEditor](https://github.com/kyouryuukunn/renpy-ActionEditor3) ⭐ 193 | 🐛 10 | 🌐 Ren'Py | 📅 2025-04-29 - A powerful director tool for manipulating [camera](https://www.renpy.org/doc/html/model.html), viewing the results and generating code to produce the interactively-defined effects.
* [renpy-TranslationTools](https://github.com/Gouvernathor/renpy-TranslationTools) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2025-11-22 - Tools to aid in managing translations in certain corner cases. Also the rare example of embedding RenPy-script in Python, rather than the reverse as is usual.
...
* [RPA Explorer](https://github.com/UniverseDevel/RPA-Explorer) ⭐ 105 | 🐛 2 | 🌐 JavaScript | 📅 2025-05-10 - Graphical explorer for RenPy Archives built around a C# library to manipulate them. Can also invoke `unrpyc` on the contents.
...
Other amazingly awesome lists can be found in [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,840 | 🐛 106 | 📅 2026-09-02, [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,212 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,680 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02.

Those should be of particular interest for RenPy users:

* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,256 | 🐛 20 | 🌐 Python | 📅 2026-09-22
